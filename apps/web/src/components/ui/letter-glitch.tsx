...
export default function LetterGlitch({
  ...
  outerVignette = true,
  smooth = true,
  characters = "CYBERSHIELD01!@#$%&*PHISHING_DEEPFAKE>SCAN<ALERT{}",
}: LetterGlitchProps) {
  ...
  return (
    <div className="relative w-full h-full bg-[#0a0a0f] overflow-hidden">
      ...
      {outerVignette && (
        <div className="absolute top-0 left-0 w-full h-full pointer-events-none bg-[radial-gradient(circle,_rgba(10,10,15,0)_40%,_rgba(10,10,15,1)_100%)]" />
      )}
      {centerVignette && (
        <div className="absolute top-0 left-0 w-full h-full pointer-events-none bg-[radial-gradient(circle,_rgba(10,10,15,0.8)_0%,_rgba(10,10,15,0)_60%)]" />
      )}
    </div>
  );
}